export default function Home() {
  return (
    <div>
      ...
      <div className="bg-sunset">Words for color to show</div>
      <div className="bg-periwinkle">Words for color to show</div>
      <div className="bg-navy">Words for color to show</div>
    </div>
  );
}
